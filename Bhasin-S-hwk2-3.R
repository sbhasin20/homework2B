...
#8 The results are identical for the nearest neighbor matching with inverse variance distance and Mahalanobis distance as well as the inverse propensity weighting. The simple linear regression was similar to the other estimators.  
